    ...
    <div class="aktion">
      ...
      <div class="tovary">
        <?php
          ...
          $query = "set name utf8";
          $mysql->query($query);
          $query = "select img, name, opis, price1, price, sales.idTort, tort.idTort from sales, tort
                    where tort.idTort = sales.idTort";
          ...
          echo '<div class="tovar">
            ...
            <form action="zakaz.php" metod="post">
              <h4>'.$row["name"].'</h4>
              <p>'.$row["opis"].'</p>
              <a href="zakaz.php?id='.$row['idTort'].'"><button>Купить</button></a>
              <div class="cena1">'.$row["price1"].' Br</div>
              <div class="cena2">'.$row["price"].' Br</div>
            </form>
            </div>
          </div>';  
          }
